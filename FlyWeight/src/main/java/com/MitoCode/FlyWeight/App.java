 ...
 *
 *No se trata de crear muchos objetos de forma dinámica, sino de crear sólo un objeto intermedio 
 *para cada entidad concreta.
 */
public class App 
{
    public static void main( String[] args )
    {
        ...
        //puede usar las lineas independientemente
